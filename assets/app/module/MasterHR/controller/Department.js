Ext.define('ERPh.module.MasterHR.controller.Department',{
	extend 			: 'Ext.app.Controller',
	CheckedDataEdit	: [],

	init: function() {
        var me = this;
        me.getStore('ERPh.module.MasterHR.store.Department').load();
        me.control({
    ...
    reloadStore: function(){
        var me = this;
        me.getStore('ERPh.module.MasterHR.store.Department').reload();
    },

    viewDepartment: function(grid, record, item, index, e, eOpts){
        this.getStore('ERPh.module.MasterHR.store.Department').reload();
                ...
                if (btn == 'yes') {
                    Ext.Ajax.request({
                        ...
                        success         : function(response){
                            ...
                            me.reset();
                            var storeApproval = Ext.getStore('ERPh.module.MasterHR.store.Department');
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 1){
                    ...
                    me.reset();
                    me.getStore('ERPh.module.MasterHR.store.Department').removeAll();
                    me.getStore('ERPh.module.MasterHR.store.Department').reload();
