...
$db['erph']['db_debug'] = TRUE;
$db['erph']['cache_on'] = FALSE;
$db['erph']['cachedir'] = '';
$db['erph']['char_set'] = 'utf8';
$db['erph']['dbcollat'] = 'utf8_general_ci';
$db['erph']['swap_pre'] = '';
$db['erph']['autoinit'] = TRUE;
$db['erph']['stricton'] = FALSE;
...
$db['hrd']['username'] = 'hrdusr';
$db['hrd']['password'] = 'hrdpswd';
$db['hrd']['database'] = 'dbhrd';
$db['hrd']['dbdriver'] = 'postgre';
$db['hrd']['dbprefix'] = '';
